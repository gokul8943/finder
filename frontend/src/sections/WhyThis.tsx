...
const glassCard: React.CSSProperties = {
    ...
    boxShadow: "0 4px 32px rgba(6,182,212,0.09), 0 1.5px 3px rgba(255,255,255,0.92) inset",
};
        ...
        >
            ...
            >
                ...
                <div
                    ...
                    style={{
                        background: "linear-gradient(135deg, rgba(207,250,254,0.5) 0%, rgba(186,230,255,0.3) 100%)",
                    }}
                />
                ...
                <div className="flex-1 min-w-0 flex flex-wrap items-baseline gap-x-2 gap-y-0.5 z-10">
                    <div className="overflow-hidden">
                        <motion.span
                            initial={{ y: "110%" }}
                            animate={inView ? { y: "0%" } : {}}
                            transition={{ duration: 0.6, delay: feature.delay + 0.1, ease: [0.16, 1, 0.3, 1] }}
                            className={`inline-block font-black text-xl sm:text-2xl md:text-3xl lg:text-[2rem] bg-linear-to-r ${feature.color} bg-clip-text text-transparent leading-tight tracking-tight`}
                    ...
                    <div className="overflow-hidden">
                        <motion.span
                            ...
                            transition={{ duration: 0.55, delay: feature.delay + 0.2, ease: [0.16, 1, 0.3, 1] }}
                            className="inline-block font-light text-base sm:text-lg md:text-xl text-cyan-700/50 group-hover:text-cyan-600/75 transition-colors duration-400 leading-tight"
    ...
    return (
        <section className="relative w-full min-h-screen overflow-x-hidden">
            ...
            <div
                ...
                style={{
                    background: "linear-gradient(145deg, #e0f7fa 0%, #f0fffe 28%, #e8f4fd 55%, #cffafe 80%, #f0fdff 100%)",
                }}
            />

            {/* Blobs */}
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute -top-20 -left-20 w-64 h-64 sm:w-96 sm:h-96 rounded-full blur-3xl"
                    style={{ background: "rgba(103,232,249,0.26)" }} />
                <div className="absolute top-1/3 -right-16 w-56 h-56 sm:w-80 sm:h-80 rounded-full blur-3xl"
                    style={{ background: "rgba(14,165,233,0.15)" }} />
                <div className="absolute bottom-0 left-1/4 w-52 h-52 sm:w-72 sm:h-72 rounded-full blur-3xl"
                    style={{ background: "rgba(6,182,212,0.18)" }} />
                <div className="absolute top-2/3 right-1/3 w-36 h-36 sm:w-48 sm:h-48 rounded-full blur-2xl"
            ...
            <div
                ...
                style={{
                    backgroundImage: "radial-gradient(circle, rgba(6,182,212,0.13) 1px, transparent 1px)",
            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-8 lg:px-14 py-14 sm:py-20 lg:py-28">
                ...
                >
                    ...
                    <div
                        ...
                        style={{ background: "radial-gradient(circle, rgba(103,232,249,0.3) 0%, transparent 70%)" }}
                    />
                ...
                <motion.div
                    ...
                    className="mt-5 flex flex-col xs:flex-row items-start xs:items-center gap-3 sm:gap-4 rounded-xl sm:rounded-2xl px-4 py-4 sm:px-6 sm:py-5"
                    style={glassCard}
                >
                    <button
                        className="relative group w-full xs:w-auto px-6 py-3 sm:px-7 sm:py-3.5 rounded-lg sm:rounded-xl font-semibold text-sm tracking-wide text-white overflow-hidden transition-transform duration-200 active:scale-95"
                        style={{
                            background: "linear-gradient(135deg, #06b6d4, #0ea5e9)",
