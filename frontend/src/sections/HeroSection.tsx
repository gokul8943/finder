...
const HeroSection = () => {
  return (
    ...
    >
      {/* Bright overlay to match the light cyan aesthetic */}
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div
          ...
          style={{ background: "rgba(14, 165, 233, 0.12)", animationDelay: "2s" }}
        />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-5 sm:px-8 gap-5 sm:gap-6">
        {/* Eyebrow tag */}
        <div
          className="fade-in inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-[11px] sm:text-xs font-medium tracking-widest uppercase text-cyan-700 border border-cyan-300/40"
          style={{
        ...
        <p
          className="fade-in max-w-md sm:max-w-lg text-sm sm:text-base text-slate-700 font-light leading-relaxed"
        ...
        <div className="hero-cta flex flex-col xs:flex-row items-center gap-3 sm:gap-4 mt-2">
          ...
          <a
            href="#how-it-works"
            className="px-6 py-3 sm:px-7 sm:py-3.5 rounded-2xl text-sm font-medium text-cyan-700 border border-cyan-300/40 hover:border-cyan-400/60 hover:text-cyan-800 hover:bg-cyan-50/50 backdrop-blur-sm transition-all duration-300"
          >
            Learn More
          </a>
        </div>
